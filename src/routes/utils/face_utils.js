...
//     img.putText(index + ' - ' + content,new cv.Point2(rect.x,rect.y + rect.height + 30),0,20,new cv.Vec3(30,212,0));
// };
//
...
//         const thickness = numDetections[index] < num_detections_th ? 1000 : 2000;
//
